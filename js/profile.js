        ...
        if (user) {
            ...
            if (avatarElement) {
                if (user.photo_url) {
                    ...
                    avatarElement.style.backgroundImage = `url('https://via.placeholder.com/80/333333/ffffff?text=User')`;
                }
            }
            ...
            const avatarElement = document.getElementById('tg-avatar');
            if (avatarElement) {
                avatarElement.style.backgroundImage = `url('https://via.placeholder.com/80/333333/ffffff?text=Guest')`;
            }
        }
    } else {
